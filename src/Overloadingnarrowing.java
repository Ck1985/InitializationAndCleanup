...
public class Overloadingnarrowing {
    ...
    void testOverloadingNarrowing(){
        double x = 0;
        print("Overloading Narrowing: ");
        f1(x); f2((float)x); f3((long)x); f4((int)x); f5((short)x); f6((byte)x); f7((char)x);
    }

    public static void main(String[] args){
        Overloadingnarrowing obj = new Overloadingnarrowing();
        obj.testOverloadingNarrowing();
    }
}
